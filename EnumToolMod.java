...
{
	//cilo materialu,pocet pouziti,nwm,damage,nwm
    BRASS(4, 200, 6.0F, 1.0F, 14),
    STEEL(5, 500, 2.0F, 2.0F, 14);
    /**
    ...
    private EnumToolMod(int par3, int par4, float par5, float par6, int par7)
    {
